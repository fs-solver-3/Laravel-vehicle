<template>
    <div
        class="col-xl-12 col-lg-12 p-0 personal-chat-container personal-fixed-chat--container"
    >
...
export default {
    ...
    methods: {
        ...
        archive() {
            ...
            let formData = new FormData();
            formData.append("user_id", this.receiver.id);
            formData.append("archive", this.menuOptions[1].active);
            axios
            .post("/adminroomArchive", formData, config)
            .then(response => {
               console.log('success');
            });
        },
