                        ...
                        <div class="col-xl-6 col-lg-6 p-0 all-trip--popup__col profile-add-car car-brand-container">
                            ...
                            <div class="trip-select-car">
                                ...
                                <div class="trip-select--car--name">
                                    <div class="trip-select--car--name1" id="selected_brand_name" @if(is_null($car)) data-id="0" @else data-id="{{$car->name}}" @endif>
                                        @if(is_null($car)) Выберите марку автомобиля @else {{$car->name}}  @endif
                                    </div>
                                </div>
                                </div>
                    ...
                    <div class="personal-add--car--item">
                        ...
                        <div class="col-xl-6 col-lg-6 p-0 all-trip--popup__col profile-add-car car-model-container">
                            ...
                            <div class="trip-select-car">
                                <div class="trip-select--icon--car">
                                <div class="trip-select--car--name">
                                    <div class="trip-select--car--name1" id="selected_model_name" @if(is_null($car)) data-id="0" @else data-id="{{$car->model}}" @endif >
                    ...
                    <div class="personal-add--car--item" id="body_type">
                        ...
                        <div class="col-xl-10 col-lg-10 p-0 all-trip--popup__col" id="body_type">
                            <ul class="personal-type-car--list" id="car_body_type">
                                @if($type == 'car'))
                                    <li class="personal-type-car--item ">
                        ...
                        <div class="container">
                          <div class="car-place--wrapper">
                            ...
                            <div class="car-place--content">
                              @if($type == 'bus')
                                <div class="col-xl-5 car-place--position car-choise-mini-bus active">
                                    ...
                                    <svg class="icon icon-kreslo-booked">
                                    ...
                                    <svg class="icon icon-bus-place-booked">
                                ...
                                <div class="col-xl-5 car-place--position car-choise-bus">
                                    <div class="car-place--svg">
                              ...
                              @endif
                              @if($type == 'car')
                              <div class="col-xl-5 car-place--position car-choise-miniven">
                                <div class="car-place--svg">
                              ...
                              <div class="col-xl-5 car-place--position car-choise-car active">
                                <div class="car-place--svg">
