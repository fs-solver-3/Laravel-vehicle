    ...
    <section class="you-trip">
        <div class="container">
          <div class="you-trip--wrap">
            <h1 class="main-section--title text-center">@lang('front.trip_old.old') <span>@lang('front.profile_trips.trip')</span></h1>
                ...
                @if(count($trips) > 0)
                    ...
                    <div class="driver-trips">
                        ...
                        <div class="car-to-book--item--top">
                          <span class="car-to-book--item--date">{{Helper::dateFormat($trip->starting_date)}} {{date('H:i',strtotime($trip->starting_date))}}</span>
                          @if(!is_null($trip))
                              <div class="gogocar-trip--item__top">
            ...
            {{-- <a href="{{ route('trips.old', app()->getLocale()) }}">
              <div class="gogocar-gray-button">Прошлые поездки</div>
            </a> --}}
          </div>
        </div>
    </section>
