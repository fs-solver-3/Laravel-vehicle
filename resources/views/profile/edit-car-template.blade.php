@php
    if($request->get('add_car')){
        $car = null;
    }
    // $colors = ['#FFFFFF', '#FDAB3E', '#F37535', '09B983', '41479B', 'EE6161', 'EC4343', '95662F', 'C1C1C1', 'C1C1C1', '45AFE3', 'CAF8FF'];
@endphp
    <form id="add_car">
        <div class="personal-content--main">
            <div class="personal-content--header mb-0">
                <h3 class="personal-content--header--title">@lang('front.profile.car_tab.add_car')</h3>
            </div>
            <div class="personal-content--body">
                <div class="personal-add--car--list @if(Route::currentRouteName()=='profile.truck.edit' || $request->get('add_car') == 'truck') show @endif" id="type_vehicle">
                    <div class="personal-add--car--item">
                        <div class="personal-add--car--title">@lang('front.profile.car_tab.what_car')?</div>
                        <p class="personal-add--car--desc">@lang('front.profile.car_tab.to_determins').</p>
                        <div class="col-xl-6 col-lg-6 personal-add--car__wrap">
                            <div class="all-trip--popup__col personal-content--select">
                                <label>Тип авто:</label>
                                @if($request->get('add_car'))
                                    @switch($request->get('add_car'))
                                        @case('car')
                                            <input class="gogocar-input--filter personal-content--input" type="text" id="car_type2" value="@lang('front.profile.add_car.passenger')" readonly required>
                                            <input class="gogocar-input--filter personal-content--input" type="hidden" id="car_type" value="Легковая" readonly required>
                                            @break
                                        @case('truck')
                                            <input class="gogocar-input--filter personal-content--input" type="text" id="car_type2" value="@lang('front.profile.add_car.freight')" readonly required>
                                            <input class="gogocar-input--filter personal-content--input" type="hidden" id="car_type" value="Грузовая" readonly required>
                                            @break
                                        @case('bus')
                                            <input class="gogocar-input--filter personal-content--input" type="text" id="car_type2" value="@lang('front.profile.add_car.bus')" readonly required>
                                            <input class="gogocar-input--filter personal-content--input" type="hidden" id="car_type" value="bus" readonly required>
                                            @break
                                        @default
                                            
                                    @endswitch
                                    {{-- <option value="Легковая" @if($request->get('add_car') == 'car' ) selected @endif>@lang('front.profile.add_car.passenger')</option>
                                    <option value="Грузовая" @if($request->get('add_car') == 'truck' ) selected @endif>@lang('front.profile.add_car.freight')</option>
                                    <option value="bus" @if($request->get('add_car') == 'bus' ) selected @endif>@lang('front.profile.add_car.bus')</option> --}}
                                @else
                                    @switch(Route::currentRouteName())
                                        @case('profile.car.edit')
                                            @if($car->type == 'bus')
                                                <input class="gogocar-input--filter personal-content--input" type="text" id="car_type2" value="@lang('front.profile.add_car.bus')" readonly required>
                                                <input class="gogocar-input--filter personal-content--input" type="hidden" id="car_type" value="bus" readonly required>
                                            @else
                    ...
                    <div class="personal-add--car--item">
                        <div class="personal-add--car--title">@lang('front.profile.car_tab.what_number')?</div>
                        <p class="personal-add--car--desc">@lang('front.profile.car_tab.only_your').</p>
                        <div class="col-xl-6 col-lg-6 p-0 personal-add--car__wrap--input--select">
                            <div class="personal-add--car__wrap mr-3">
                                <div class="all-trip--popup__col personal-content--select">
                                    <label>@lang('front.profile.add_car.car_type'):</label>
                                    <div class="choise-country--gogocar">
                                        @if(isset($car) && $car->country != null)
                                            @if($car->country == 'UZ')
                                                <div class="choise-country--flag--code">
                                                    <div class="choise-country--flag" style="background-image:url('/static/img/general/lang/uz.png');"></div>
                                                    <div class="choise-country--code car-number-flag">UZ</div>
                                                </div>
                                            @else
                                                <div class="choise-country--flag--code">
                                                    <div class="choise-country--flag" style="background-image:url('/static/img/general/lang/ru.png');"></div>
                                                    <div class="choise-country--code car-number-flag">RU</div>
                                                </div>
                                            @endif
                                        @else
                                            <div class="choise-country--flag--code">
                                        ...
                                        @endif
                                        <div class="choise-country--show--list">
                                            <svg class="icon icon-arrow-right ">
                                                <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#arrow-right') }}"></use>
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="choise-country--gogocar--list">
                                        <li class="choise-country--gogocar--item">
                                            <div class="choise-country--flag" style="background-image:url('/static/img/general/lang/ru.png');"></div>
                                            <div class="choise-country--code" data-code="RU" data-placeholder="А-999-AA-999">RU
                                            </div>
                                        </li>
                                        <li class="choise-country--gogocar--item">
                                            <div class="choise-country--flag" style="background-image:url('/static/img/general/lang/uz.png');"></div>
                                            <div class="choise-country--code" data-code="UZ" data-placeholder="99-A-999-AA">UZ
                                            </div>
                                        </li>
                                    </div>
                                </div>
                            </div>
                            <div class="personal-add--car__wrap">
                                <div class="all-trip--popup__col personal-content--select">
                                    <label> </label>
                                    <div class="error-block" id="number-valid">
                                        <span class="invalid-feedback" role="alert">
                                            <strong>@lang('front.profile.add_car.wrong_number')</strong>
                                        </span>
                                    </div>
                                    <input id="gogocar-number" class="gogocar-input--filter personal-content--input text-center ccp--gogocar " type="text" placeholder="" value="{{ old('number', optional($car)->number) }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="personal-add--car--item">
                        <div class="personal-add--car--title">@lang('front.profile.car_tab.what_brand')?</div>
                        <div class="col-xl-6 col-lg-6 p-0 all-trip--popup__col profile-add-car car-brand-container">
                            {{-- <label> </label>
                            <select class="form-control select" id="car_brand" required>
                                <option value="" style="display: none;" disabled @if(is_null($car)) selected @endif>@lang('front.profile.add_car.select_car_brand')</option>
                                @foreach ($carBrands as $key => $item)
                                <option value="{{ $item->id }}" @if(!is_null($car) && $car->name == $item->name) selected @endif>{{ $item->name }}</option>
                                @endforeach
                            </select> --}}
                            <div class="personal-add--car--mark" id="car_brand_blocks">
                            </div>
                            <div class="trip-select-car">
                                <div class="trip-select--icon--car">
                                <div class="trip-select--car--name">
                                    <div class="trip-select--car--name1" id="selected_brand_name" @if(is_null($car)) data-id="0" @else data-id="{{$brand->id}}" @endif>
                                        @if(is_null($car)) Выберите модель автомобиля @else {{$car->name}}  @endif
                                    </div>
                                </div>
                                </div>
                            ...
                            <ul class="trip-select-car--list">
                                <div class="search-block">
                                    <input class="brand-select gogocar-input--filter personal-content--input personal-search-car--input" type="search" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox">
                                    <div class="notific-calendar-icon">
                                        <svg class="icon icon-search ">
                                            <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#search') }}"></use>
                                        </svg>
                                    </div>
                                    <div id="car_brand_template">
                                        @include('profile.car_brand_template')
                                    </div>
                                </div>
                            </ul>
                        </div>
                    ...
                    <div class="personal-add--car--item">
                        <div class="personal-add--car--title">@lang('front.profile.car_tab.what_model')?</div>
                        <div class="col-xl-6 col-lg-6 p-0 all-trip--popup__col profile-add-car car-model-container">
                            {{-- <label> </label>
                            <select class="form-control select2" id="car_model" required>
                                <option value="" style="display: none;" disabled @if(is_null($car)) selected @endif>@lang('front.profile.add_car.select_car_model')</option>
                                @foreach ($carModels as $key => $item)
                                <option value="{{ $item->name }}" @if(!is_null($car) && $car->model== $item->name)  selected @endif>
                                    {{ $item->name }}
                                </option>
                                @endforeach
                            </select> --}}
                            <div class="trip-select-car">
                                <div class="trip-select--icon--car">
                                <div class="trip-select--car--name">
                                    <div class="trip-select--car--name1" id="selected_model_name" @if(is_null($car)  || $car->car_model_id == null) data-id="0" @else data-id="{{$car->car_model_id}}" @endif >
                                        @if(is_null($car)) Выберите модель автомобиля @else {{$car->model}}  @endif
                                    </div>
                                </div>
                                </div>
                                <div class="trip-select--arrow">
                            ...
                            <ul class="trip-select-car--list">
                                <div class="search-block">
                                    <input class="model-select gogocar-input--filter personal-content--input personal-search-car--input" type="search" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox">
                                    <div class="notific-calendar-icon">
                                        <svg class="icon icon-search ">
                                            <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#search') }}"></use>
                                        </svg>
                                    </div>
                                    <div id="car_model_template">
                                        @include('profile.car_model_template')
                                    </div>
                                </div>
                            </ul>
                        </div>
                    </div>
                    <div class="personal-add--car--item" id="body_type">
                        <div class="personal-add--car--title">@lang('front.profile.car_tab.what_type_of_body')?</div>
                        <div class="col-xl-10 col-lg-10 p-0 all-trip--popup__col" id="body_type">
                            <ul class="personal-type-car--list" id="car_body_type">
                                @if($request->get('add_car') == 'car' ||  (Route::currentRouteName() == 'profile.car.edit' && $car->type == 'Легковая'))
                                <li class="personal-type-car--item @if(!is_null($car) && $car->body_type == 'Хэтчбек') active @endif">
                                    <div class="personal-type-car--item__icon">
                                        <svg class="icon icon-car-hb ">
                                            <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#car-hb') }}"></use>
                                        </svg>
                                        <div class="personal-type-car--item--name">Хэтчбек</div>
                                    </div>
                                    <div class="personal-type-car--item__checkbox"></div>
                                </li>
                                <li class="personal-type-car--item @if(!is_null($car) && $car->body_type == 'Седан') active @endif">
                                    <div class="personal-type-car--item__icon">
                                        <svg class="icon icon-car-sedan ">
                                            <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#car-sedan') }}"></use>
                                        </svg>
                                        <div class="personal-type-car--item--name">Седан</div>
                                    </div>
                                    <div class="personal-type-car--item__checkbox"></div>
                                </li>
                                <li class="personal-type-car--item @if(!is_null($car) && $car->body_type == 'Кабриолет') active @endif">
                                    <div class="personal-type-car--item__icon">
                                        <svg class="icon icon-car-cabri ">
                                            <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#car-cabri') }}"></use>
                                        </svg>
                                        <div class="personal-type-car--item--name">Кабриолет</div>
                                    </div>
                                    <div class="personal-type-car--item__checkbox"></div>
                                </li>
                                <li class="personal-type-car--item @if(!is_null($car) && $car->body_type == 'Универсал') active @endif">
                                    <div class="personal-type-car--item__icon">
                                        <svg class="icon icon-car-un ">
                                            <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#car-un') }}"></use>
                                        </svg>
                                        <div class="personal-type-car--item--name">Универсал</div>
                                    </div>
                                    <div class="personal-type-car--item__checkbox"></div>
                                </li>
                                <li class="personal-type-car--item @if(!is_null($car) && $car->body_type == 'Кроссовер') active @endif">
                                    <div class="personal-type-car--item__icon">
                                        <svg class="icon icon-car-kro ">
                                            <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#car-kro') }}"></use>
                                        </svg>
                                        <div class="personal-type-car--item--name">Кроссовер</div>
                                    </div>
                                    <div class="personal-type-car--item__checkbox"></div>
                                </li>
                                @endif
                                <li class="personal-type-car--item @if(!is_null($car) && $car->body_type == 'Минивен') active @endif">
                                    <div class="personal-type-car--item__icon">
                                        <svg class="icon icon-car-min ">
                                            <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#car-min') }}"></use>
                                        </svg>
                                        <div class="personal-type-car--item--name">Минивен</div>
                                    </div>
                                    <div class="personal-type-car--item__checkbox"></div>
                                </li>
                            </ul>
                            @if($request->get('add_car') == 'truck' ||  Route::currentRouteName() == 'profile.truck.edit')
                            <ul class="personal-type-car--list" id="truck_body_type">
                                @if(count($truck_body_types) > 0)
                                    @foreach ($truck_body_types as $item)
                                        <li class="personal-type-car--item @if(Route::currentRouteName()=='profile.truck.edit' && $car->body_type_id == $item->id) active @endif">
                                            <div class="personal-type-car--item__icon">
                                                <div class="personal-type-car--item--name">{{ $item->name }}</div>
                                            </div>
                                            <div class="personal-type-car--item__checkbox" data-id="{{ $item->id }}"></div>
                                        </li>
                                    @endforeach
                                @endif
                            </ul>
                    ...
                    @if((Route::currentRouteName() == 'profile.truck.edit'))
                        <div class="personal-add--car--item" id="cargo_type">
                            <div class="personal-add--car--title">@lang('front.profile.car_tab.what_type_of_good')?</div>
                            <div class="col-xl-10 col-lg-10 p-0 all-trip--popup__col">
                                <ul class="personal-type-car--list">
                                    @if(count($cargo_types) > 0)
                                        @foreach ($cargo_types as $item)
                                            <li class="personal-type-car--item-2 @if(Route::currentRouteName()=='profile.truck.edit' && in_array($item->id, $cargoTypes)) active @endif">
                                                <div class="personal-type-car--item__icon">
                                                    <div class="personal-type-car--item--name">{{ $item->type_name }}</div>
                                                </div>
                                                <div class="personal-type-car--item__checkbox" data-id="{{ $item->id }}"></div>
                                            </li>
                                        @endforeach
                    ...
                    <section class="car-place">
                        <div class="container">
                          <div class="car-place--wrapper">
                            <div class="personal-add--car--title">На каком месте вы хотите ехать ?</div>
                            {{-- <h1 class="main-section--title text-center mb-5">На каком месте <span>вы хотите ехать ?</span></h1> --}}
                            <div class="car-place--content">
                              @if($car->type == 'bus')
                                <div class="col-xl-5 car-place--position car-choise-mini-bus @if($car->template == 'car-choise-mini-bus') active @endif">
                                    ...
                                    <!-- Водительский ряд-->
                                    <div class="car-place--svg--places car-place-front-left--minibus minibus-front" data-car-place="Первое место (Водительский ряд)">
                                    ...
                                    <div class="car-place--svg--places car-place-front-right--minibus minibus-front" data-car-place="Второе место (Водительский ряд)" data-place-booked="Место забронировано">
                                    <svg class="icon icon-kreslo-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-top--minibus__1 minibus-passanger-1" data-car-place="Первое место (Пасажирские места 'Верхний ряд')">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-booked')}}"></use>
                                    </svg>
                                    </div>
                                    <div class="car-place--svg--places car-place-passenger-top--minibus__2 minibus-passanger-1" data-car-place="Второе место (Пасажирские места 'Верхний ряд')" data-place-booked="Место забронировано">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-top--minibus__3 minibus-passanger-1" data-car-place="Третье место (Пасажирские места 'Верхний ряд')">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-middle--minibus__1 minibus-passanger-2" data-car-place="Первое место (Пасажирские места 'Центральный ряд')">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-middle--minibus__2 minibus-passanger-2" data-car-place="Первое место (Пасажирские места 'Центральный ряд')" data-place-booked="Место забронировано">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-middle--minibus__3 minibus-passanger-2" data-car-place="Первое место (Пасажирские места 'Центральный ряд')">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-bottom-left--minibus__1" data-car-place="Первое место (Пасажирские места 'Левый-нижний ряд')">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-bottom-left--minibus__2" data-car-place="Второе место (Пасажирские места 'Левый-нижний ряд')" data-place-booked="Место забронировано">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-bottom-left--minibus__3" data-car-place="Третье место (Пасажирские места 'Левый-нижний ряд')">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-bottom-right--minibus__1" data-car-place="Первое место (Пасажирские места 'Левый-нижний ряд')">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-bottom-right--minibus__2" data-car-place="Второе место (Пасажирские места 'Левый-нижний ряд')" data-place-booked="Место забронировано">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                    ...
                                    <div class="car-place--svg--places car-place-passenger-bottom-right--minibus__3" data-car-place="Третье место (Пасажирские места 'Левый-нижний ряд')">
                                    <svg class="icon icon-bus-place-free ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                    </svg>
                                    <svg class="icon icon-bus-place-booked icon-car-place--booked">
                              ...
                              <div class="col-xl-5 car-place--position car-choise-bus @if($car->template == 'car-choise-bus' || $car->template == null) active @endif">
                                <div class="car-place--svg">
                                ...
                                <!-- Левая сторона-->
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-first" data-car-place="Левая сторона (Первый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-first" data-car-place="Левая сторона (Первый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-second" data-car-place="Левая сторона (Второй ряд)" data-place-booked="Место забронировано">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-second" data-car-place="Левая сторона (Второй ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-three" data-car-place="Левая сторона (Третий ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-three" data-car-place="Левая сторона (Третий ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-four" data-car-place="Левая сторона (Четвертый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-four" data-car-place="Левая сторона (Четвертый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-five" data-car-place="Левая сторона (Пятый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-five" data-car-place="Левая сторона (Пятый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-six" data-car-place="Левая сторона (Шестой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-six" data-car-place="Левая сторона (Шестой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-seven" data-car-place="Левая сторона (Седьмой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-seven" data-car-place="Левая сторона (Седьмой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-eight" data-car-place="Левая сторона (Восьмой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-eight" data-car-place="Левая сторона (Восьмой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-left--bus bus-top-nine" data-car-place="Левая сторона (Девятый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-left-right--bus bus-top-nine" data-car-place="Левая сторона (Девятый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <!-- Правая сторона-->
                                <div class="car-place--svg--places car-place-right-left--bus bus-top-second" data-car-place="Правая сторона (Второй ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-right--bus bus-top-second" data-car-place="Правая сторона (Второй ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-left--bus bus-top-three" data-car-place="Правая сторона (Третий ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-right--bus bus-top-three" data-car-place="Правая сторона (Третий ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-left--bus bus-top-four" data-car-place="Правая сторона (Четвертый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-right--bus bus-top-four" data-car-place="Правая сторона (Четвертый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-left--bus bus-top-five" data-car-place="Правая сторона (Пятый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-right--bus bus-top-five" data-car-place="Правая сторона (Пятый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-left--bus bus-top-six" data-car-place="Правая сторона (Шестой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-right--bus bus-top-six" data-car-place="Правая сторона (Шестой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-left--bus bus-top-seven" data-car-place="Правая сторона (Седьмой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-right--bus bus-top-seven" data-car-place="Правая сторона (Седьмой ряд)" data-place-booked="Место забронировано">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-left--bus bus-top-eight" data-car-place="Правая сторона (Восьмой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-right--bus bus-top-eight" data-car-place="Правая сторона (Восьмой ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-left--bus bus-top-nine" data-car-place="Правая сторона (Девятый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-right-right--bus bus-top-nine" data-car-place="Правая сторона (Девятый ряд)">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <!-- Задние места-->
                                <div class="car-place--svg--places car-place-back-1--bus" data-car-place="Заднее место 1">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-back-2--bus" data-car-place="Заднее место 2">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-back-3--bus" data-car-place="Заднее место 3">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-back-4--bus" data-car-place="Заднее место 4" data-place-booked="Место забронировано">
                                  <svg class="icon icon-bus-place-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                              ...
                              @else
                              <div class="col-xl-5 car-place--position car-choise-miniven @if($car->template == 'car-choise-miniven') active @endif">
                                <div class="car-place--svg">
                                ...
                                <!-- Водительский ряд-->
                                <div class="car-place--svg--places car-place-front-left--miniven" data-car-place="Первое место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <!---->
                                <div class="car-place--svg--places car-place-passanger--miniven__1" data-car-place="Второе место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-passanger--miniven__2" data-car-place="Первое место (Водительский ряд)" data-place-booked="Место забронировано">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-passanger--miniven__3" data-car-place="Первое место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-passanger--miniven__4" data-car-place="Первое место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-passanger--miniven__5" data-car-place="Первое место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-passanger--miniven__6" data-car-place="Первое место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                              ...
                              <div class="col-xl-5 car-place--position car-choise-car @if($car->template == 'car-choise-car' || $car->template == null) active @endif">
                                <div class="car-place--svg">
                                ...
                                <div class="car-place--svg--places car-place-front-left--car" data-car-place="Первое место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <!---->
                                <div class="car-place--svg--places car-place-passanger--car__1" data-car-place="Второе место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-passanger--car__2" data-car-place="Первое место (Водительский ряд)" data-place-booked="Место забронировано">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                                ...
                                <div class="car-place--svg--places car-place-passanger--car__3" data-car-place="Первое место (Водительский ряд)">
                                  <svg class="icon icon-kreslo-free ">
                                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                                  </svg>
                                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                              ...
                              <div class="col-xl-7 car-place--info">
                                ...
                                <div class="trip-select-car">
                                  <div class="trip-select--icon--car">
                                    ...
                                    <div class="trip-select--car--name">
                                      ...
                                      <input class="form-control" name="template" type="hidden" id="template" value="{{ old('template', optional($car)->template) }}">
                                    </div>
                                  </div>
                                  <div class="trip-select--arrow">
                                    <svg class="icon icon-arrow-right ">
                                ...
                                <ul class="trip-select-car--list car-select-car--list">
                                  @if($car->type == 'bus')
                                    <li class="trip-select-car--item suggest-late--result--item choise-car-tab @if($car->template == 'car-choise-mini-bus') active @endif" data-car-choise="car-choise-mini-bus">
                                  ...
                                  <li class="trip-select-car--item suggest-late--result--item choise-car-tab @if($car->template == 'car-choise-bus' || $car->template == null) active @endif" data-car-choise="car-choise-bus">
                                    <div class="suggest-late--result--item__left">
                                      <div class="gogocar-gray-icons">
                                        <svg class="icon icon-taxi ">
                                          <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#taxi')}}"></use>
                                  ...
                                  @else
                                  <li class="trip-select-car--item suggest-late--result--item choise-car-tab @if($car->template == 'car-choise-miniven') active @endif" data-car-choise="car-choise-miniven">
                                    <div class="suggest-late--result--item__left">
                                      <div class="gogocar-gray-icons">
                                        <svg class="icon icon-taxi ">
                                          <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#taxi')}}"></use>
                                  ...
                                  <li class="trip-select-car--item suggest-late--result--item choise-car-tab @if($car->template == 'car-choise-car' || $car->template == null) active @endif" data-car-choise="car-choise-car">
                                    <div class="suggest-late--result--item__left">
                                      <div class="gogocar-gray-icons">
                                        <svg class="icon icon-taxi ">
                                          <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#taxi')}}"></use>
                    ...
                    {{-- end car template --}}
                    <div class="personal-add--car--item">
                        <div class="personal-add--car--title mb-4">@lang('front.profile.car_tab.what_color')?</div>
                        <div class="col-xl-10 col-lg-10 p-0 all-trip--popup__col">
                            <ul class="personal-color-car--list row">
                                @foreach ($colors as $item)
                                    <li class="personal-color-car--item @if(!is_null($car) && $car->color == $item->color) active @endif" data-car-color="{{ $item->color }}" @if(!is_null($car) && $car->color == $item->color) style="box-shadow: {{$item->color}} 0px 0px 0px 6px" @endif></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    <div class="personal-add--car--item mb-5">
                        <div class="personal-add--car--title">@lang('front.profile.car_tab.what_year')?</div>
                        <p class="personal-add--car--desc">@lang('front.profile.car_tab.passengers_will')</p>
                        <div class="col-xl-6 col-lg-6 personal-add--car__wrap">
                            <div class="all-trip--popup__col personal-content--select">
                                <label>@lang('front.profile.car_tab.enter_year'):</label>
                                <input class="gogocar-input--filter personal-content--input mask-year" type="number" min="1900" max="{{ now()->year }}" id="car_year" placeholder="Введите год" value="{{ old('year', optional($car)->year) }}" required>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" id="action_url" value="{{Route::currentRouteName()}}">
                    @if(!is_null($car))
                        <input type="hidden" id="car_id" value="{{ $car->id }}">
                    @endif
                </div>
                <button type="submit" class="gogocar-yellow-button m-0 gogocar-mobile-m-0-auto" >
                    @lang('front.profile.car_tab.save')
                </button>
            </div>
        </div>
    </form>
...
<div class="modal fade" id="popup-input-car-data" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="modal fade" id="popup-input-car-wrong" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered popup-modal--wrap" role="document">
        <div class="modal-content popup-content">
            <div class="popup-covid--wrap popup-icon-size">
                <p class="popup-trip-finish">@lang('message.something_wrong')</p>
                <div class="gogocar-yellow-button w-170" dis-miss="modal">Ок</div>
            </div>
        </div>
    </div>
</div> 
...
<script>
    window.profile_url = "{{ route('profile', ['locale' => app()->getLocale(), 'tab' => 'car']) }}";
    window.update_car_url = '{{ route('profile.car.update', app()->getLocale()) }}';
    $(document).ready(function() {
        $('.select2').select2();

        var get_car_template = $('.car-select-car--list .choise-car-tab.active').text();
        $('.trip-select--car--name .trip-select--car--name2').text(get_car_template);
        var get_tab = $('.car-select-car--list .choise-car-tab.active').attr('data-car-choise');
        $('#template').val(get_tab);

        $('.brand-select').on('input', function(){
            var input = $(this).val();
            $.ajax({
                type: 'get',
                url: '{{ route("api.car_brands.search") }}',
                dataType: 'json',
                data: {
                    term: input
                },
                success: function(data) {
                    // lastOptions = data;
                    $('#car_brand_template').html(data['template']);
                    $('#selected_model_name').text('Выберите модель автомобиля');
                    $('#selected_model_name').attr('data-id', 0);
                    // options.callback({ results: data.results });
                }
            });
        })

        $('.model-select').on('input', function(){
            var input = $(this).val();
            var brand = $('#selected_brand_name').attr('data-id');
            $.ajax({
                type: 'get',
                url: '{{ route("api.car_models.search") }}',
                dataType: 'json',
                data: {
                    term: input,
                    brand: brand
                ...
                success: function(data) {
                    $('#car_model_template').html(data['template']);
                    // $('#car_model_template').html(data);
                }
            });
        })


        $(document).on('click', '.car-brand-container .personal-add--car--mark--item', function(){
            var get_car_brand = $(this).children('.personal-add--car--mark--name').text();
            var get_car_brand_id = $(this).data('brand');
            $('#selected_brand_name').text(get_car_brand);
            $('#selected_brand_name').attr('data-id', get_car_brand_id);
            $('.trip-select-car--list').slideUp(200);
            var brand_id = $(this).data('brand');
            fetch_models(brand_id);
        });

        $(document).on('click', '.car-model-container .personal-add--car--mark--item', function(){
            var get_car_model = $(this).children('.personal-add--car--mark--name').text();
            var get_car_model_id = $(this).data('model');
            $('#selected_model_name').text(get_car_model);
            $('#selected_model_name').attr('data-id', get_car_model_id);
            $('.trip-select-car--list').slideUp(200);
        });

        function fetch_models(query) {
            $.ajax({
                url: "/fetch_models2?query=" + query,
                success: function (data) {
                    $('#car_model_template').html('');
                    $('#car_model_template').html(data);
                    $('#selected_model_name').text('Выберите модель автомобиля');
                    $('#selected_model_name').attr('data-id', 0);
                }
        ...
        // $('#gogocar-number').mask('A-9999-99');
        var car_number_country = $('.car-number-flag').html();
        if(car_number_country == 'RU'){
            $('#gogocar-number').attr('placeholder', 'A-999-AA-999');
            $('#gogocar-number').mask('A-999-AA-999');
        }
        else{
            $('#gogocar-number').attr('placeholder', '00-A-999-AA');
            $('#gogocar-number').mask('00-A-999-AA');
        }

        $('.personal-add--car__wrap .choise-country--gogocar--item').click(function(){
            var car_number_country = $('.car-number-flag').html();
            $('#gogocar-number').attr('placeholder', $(this).data('placeholder'));
            if($(this).children('.choise-country--code').data('code') == 'RU'){
                $('#gogocar-number').mask('A-999-AA-999');
            }
            else{
                $('#gogocar-number').mask('00-A-999-AA');
