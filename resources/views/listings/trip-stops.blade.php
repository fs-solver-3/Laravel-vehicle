        ...
        <div class="container">
            <div class="trip-stops--wrap">
                ...
                <ul class="col-xl-12 col-lg-12 trip-stops--list">
                    @if(Session::get('stops-passenger')!=null)
                    @foreach(Session::get('stops-passenger') as $item)
                    <li>
                ...
                <a href="{{ route('deploy_passenger_to', app()->getLocale()) }}">
                    <div class="trips-stops--added">@lang('front.trip_stops.add_settlement')</div>
                </a>
                <div class="trip-stops--places--buttons">
                    <a class="gogocar-gray-button m-0-auto-none mr-4" href="{{ route('suggest_late_to', app()->getLocale()) }}">@lang('front.trip_stops_places.back')</a>
                    <a class="gogocar-yellow-button m-0-auto-none" href="{{ route('stopPlacesPassenger', app()->getLocale()) }}" id="stops_continue">@lang('front.suggest_late_to.continue')</a>
                </div>
            </div>
        </div>
    </section>
