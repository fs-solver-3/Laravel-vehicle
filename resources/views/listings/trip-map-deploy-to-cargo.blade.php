        ...
        <div class="container">
            <div class="trip-map--wrap">
                <div class="col-xl-5 col-lg-5 col-md-7 col-sm-12 trip-map--absolute gogocar-box">
                    ...
                    <form method="POST" action="{{ route('toDetailUpdateCargo', app()->getLocale()) }}" accept-charset="UTF-8" id="stopscargo" onsubmit="return validateForm()">
                        <div class="col-xl-12 col-lg-12 suggest-late--inputs">
                            <div class="gogocar-input--wrapper">
                                ...
                                <input class="gogocar-input-v1 suggest-late--input--to map-input" id="address-input"
                                    type="text" name="dc" placeholder="Введите место...">
                                @if($lat_from)
                            ...
                            <div class="trip-map--buttons mt-3">
                                ...
                                <a href="{{route('suggest_cargo_to', app()->getLocale())}}" ><div class="gogocar-gray-button">@lang('front.trip_map_deploy.cancel')</div></a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="trip-map--buttons__mobile">
            <div class="container">
                <div class="trip-map--buttons mt-3">
                    ...
                    <a href="{{route('suggest_cargo_to', app()->getLocale())}}" class="gogocar-gray-button cancel">
...
<script>
    function validateForm() {
     ...
     $(document).ready(function() {
         $('.trip-map--buttons__mobile .next-page, .trip-map--buttons__mobile .cancel').click(function(){
