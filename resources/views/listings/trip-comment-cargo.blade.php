        ...
        <div class="container">
            <form id="comment_form" action="javascript:void(0)" enctype="multipart/form-data">
                <div class="trip-comment--wrap">
                    ...
                    {{-- <button type="submit" class="gogocar-yellow-button">@lang('front.trip_comment.publish')</button> --}}
                    <div class="trip-stops--places--buttons">
                        @if(Auth::user()->avatar == null)
                            <a class="gogocar-gray-button m-0-auto-none mr-4" href="{{ route('addPhoto_cargo', app()->getLocale()) }}">@lang('front.trip_stops_places.back')</a>
                        @else
                            <a class="gogocar-gray-button m-0-auto-none mr-4" href="{{ route('chooseCarCargo', app()->getLocale()) }}">@lang('front.trip_stops_places.back')</a>
                        @endif
...
<script>
    $(document).ready(function() {
        ...
        $('#return_trip_now').click(function(){
            window.location.href = '{{ route("setReturn_cargo", app()->getLocale()) }}';
        })
        ...
        $('#comment_form').submit(function(e) {
            ...
            $.ajax({
                ...
                url: '{{ route("saveComment_cargo", app()->getLocale()) }}',
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
