...
<div class="content">
  ...
  <form method="GET" action="{{ route('setReturntrip', app()->getLocale()) }}">
    ...
    <section class="when-trip">
      <div class="container">
        <div class="when-trip--wrap">
          ...
          <input type="hidden" id="start_date" value="{{$list_startdate}}">
          <div class="trip-stops--places--buttons">
            <button class="gogocar-yellow-button" type="submit">Продолжить</button>
            <a href="{{ route('addComment', app()->getLocale()) }}" class="gogocar-gray-button">Отмена</a>
          </div>
        </div>
      </div>
    </section>
