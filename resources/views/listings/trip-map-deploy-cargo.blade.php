...
<div class="content">
    ...
    <section class="trip-map-deploy p-0">
        <form id="stops_cargo" method="POST" action="{{ route('stopsCargo', app()->getLocale()) }}" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div class="container">
                <div class="trip-map--wrap">
                    <div class="col-xl-5 col-lg-5 col-md-7 col-sm-12 trip-map--absolute gogocar-box">
                        ...
                        <div class="main-section--title text-center mb-4">@lang('front.trip_map_deploy.drop_off')&nbsp<span>@lang('front.trip_map_deploy.cargo') ?</span></div>
                        ...
                        <div class="col-xl-12 col-lg-12 suggest-late--inputs">
                            ...
                            <div class="trip-map--buttons mt-3">
                                ...
                                <a class="gogocar-gray-button" href="{{ route('stopsListings_cargo', app()->getLocale()) }}">@lang('front.trip_map_deploy.cancel')</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="trip-map--buttons__mobile">
            <div class="container">
                <div class="trip-map--buttons mt-3">
                    ...
                    <a href="{{route('stopsListings_cargo', app()->getLocale())}}" class="gogocar-gray-button cancel">
