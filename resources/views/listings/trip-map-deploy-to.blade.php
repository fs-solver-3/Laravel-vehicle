        ...
        <div class="container">
            <div class="trip-map--wrap">
                <div class="col-xl-5 col-lg-5 col-md-7 col-sm-12 trip-map--absolute gogocar-box">
                    ...
                    <form method="POST" action="{{ route('toDetailUpdate', app()->getLocale()) }}" accept-charset="UTF-8" id="stopspassener" onsubmit="return validateForm()">
                        <div class="col-xl-12 col-lg-12 suggest-late--inputs">
                            ...
                            <div class="trip-map--buttons mt-3">
                                ...
                                <a href="{{route('suggest_late_to', app()->getLocale())}}" ><div class="gogocar-gray-button">@lang('front.trip_map_deploy.cancel')</div></a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="trip-map--buttons__mobile">
            <div class="container">
                <div class="trip-map--buttons mt-3">
                    ...
                    <a href="{{route('suggest_late_to', app()->getLocale())}}" class="gogocar-gray-button cancel">
