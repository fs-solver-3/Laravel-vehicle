...
<div class="form-row">
    <div class="form-group col-md-12 {{ $errors->has('name') ? 'has-error' : '' }}">
        <label>Model</label>
        <select class="input-main select2" id="car_model" name="car_brand_id">
            @foreach ($carBrands as $item)
            <option value="{{ $item->id }}" {{ old('car_brand_id', optional($car)->car_brand_id) == $item->id ? 'selected' : '' }}>
                {{ $item->name }}
            </option>
            @endforeach
        </select>
        ...
        <div class="container">
          <div class="car-place--wrapper">
            ...
            <div class="car-place--content">
              <div class="col-xl-5 car-place--position car-choise-bus active">
                ...
                <div class="car-place--svg--places car-place-left-left--bus bus-top-second car-place--booked" data-car-place="Левая сторона (Второй ряд)" data-place-booked="Место забронировано">
                  <svg class="icon icon-bus-place-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                  </svg>
                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                ...
                <div class="car-place--svg--places car-place-right-right--bus bus-top-seven car-place--booked" data-car-place="Правая сторона (Седьмой ряд)" data-place-booked="Место забронировано">
                  <svg class="icon icon-bus-place-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                  </svg>
                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                ...
                <div class="car-place--svg--places car-place-back-4--bus car-place--booked" data-car-place="Заднее место 4" data-place-booked="Место забронировано">
                  <svg class="icon icon-bus-place-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                  </svg>
                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
              ...
              <div class="col-xl-5 car-place--position car-choise-mini-bus">
                <div class="car-place--svg">
                ...
                <div class="car-place--svg--places car-place-front-right--minibus minibus-front car-place--booked" data-car-place="Второе место (Водительский ряд)" data-place-booked="Место забронировано">
                  <svg class="icon icon-kreslo-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                  </svg>
                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
                ...
                <div class="car-place--svg--places car-place-passenger-top--minibus__2 minibus-passanger-1 car-place--booked" data-car-place="Второе место (Пасажирские места 'Верхний ряд')" data-place-booked="Место забронировано">
                  <svg class="icon icon-bus-place-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                  </svg>
                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                ...
                <div class="car-place--svg--places car-place-passenger-middle--minibus__2 minibus-passanger-2 car-place--booked" data-car-place="Первое место (Пасажирские места 'Центральный ряд')" data-place-booked="Место забронировано">
                  <svg class="icon icon-bus-place-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                  </svg>
                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                ...
                <div class="car-place--svg--places car-place-passenger-bottom-left--minibus__2 car-place--booked" data-car-place="Второе место (Пасажирские места 'Левый-нижний ряд')" data-place-booked="Место забронировано">
                  <svg class="icon icon-bus-place-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                  </svg>
                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
                ...
                <div class="car-place--svg--places car-place-passenger-bottom-right--minibus__2 car-place--booked" data-car-place="Второе место (Пасажирские места 'Левый-нижний ряд')" data-place-booked="Место забронировано">
                  <svg class="icon icon-bus-place-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#bus-place-free')}}"></use>
                  </svg>
                  <svg class="icon icon-bus-place-booked icon-car-place--booked">
              ...
              <div class="col-xl-5 car-place--position car-choise-miniven">
                ...
                <div class="car-place--svg--places car-place-passanger--miniven__2 car-place--booked" data-car-place="Первое место (Водительский ряд)" data-place-booked="Место забронировано">
                  <svg class="icon icon-kreslo-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                  </svg>
                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
              ...
              <div class="col-xl-5 car-place--position car-choise-car">
                <div class="car-place--svg">
                ...
                <div class="car-place--svg--places car-place-passanger--car__2 car-place--booked" data-car-place="Первое место (Водительский ряд)" data-place-booked="Место забронировано">
                  <svg class="icon icon-kreslo-free ">
                    <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#kreslo-free')}}"></use>
                  </svg>
                  <svg class="icon icon-kreslo-booked icon-car-place--booked">
              ...
              <div class="col-xl-7 car-place--info">
                ...
                <ul class="trip-select-car--list car-select-car--list">
                  ...
                  <li class="trip-select-car--item suggest-late--result--item choise-car-tab" data-car-choise="car-choise-car">
                    <div class="suggest-late--result--item__left">
                      <div class="gogocar-gray-icons">
                        <svg class="icon icon-taxi ">
                          <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#taxi')}}"></use>
