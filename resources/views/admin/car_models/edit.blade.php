...
<ul class="choise-lang--list">
    <li class="choise-lang--item"
        data-value='{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), ['locale' => 'en', 'id' => $carModel->id])}}'>
...
<section class="section-1">
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
              ...
              <div class="pull-left">
                  <a href="{{ route('admin.car_model.index', app()->getLocale()) }}" class="back_to_link" title="Show All Cars">
                      <img src="{{asset('admin/left-arrow.svg')}}" class="left-arrow" alt="for you">
                  </a>
                  <span class="pull-left admin-form-title">
                      <h4 >{{ !empty($carModel->name) ? $carModel->name : 'Car' }}</h4>
                  </span>
              </div>
              <div class="btn-group btn-group-sm pull-right" role="group">

                  <a href="{{ route('admin.car_model.create', app()->getLocale()) }}" class="btn btn-add" title="Create New Car">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.car_model.update', ['locale' => app()->getLocale(), 'id' => $carModel->id]) }}" id="edit_car_form" name="edit_car_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
