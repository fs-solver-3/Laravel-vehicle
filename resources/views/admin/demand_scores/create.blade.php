...
<section class="section-1">
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <a class="back_to_link" href="{{ route('admin.demand_score.index', app()->getLocale()) }}">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.demand_score.store', app()->getLocale()) }}" accept-charset="UTF-8" id="create_demand_status_form" name="create_demand_status_form" class="form-horizontal">
                {{ csrf_field() }}
