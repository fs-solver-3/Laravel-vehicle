...
<section>
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <a class="back_to_link" href="{{ route('admin.reason.index', app()->getLocale()) }}">
                <img src="{{asset('admin/left-arrow.svg')}}" class="left-arrow" alt="for you">
            </a>

            <span class="pull-left admin-form-title">
                <h4>@lang('global.create_new') @lang('global.reason.title')</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.reason.store', app()->getLocale()) }}" accept-charset="UTF-8" id="create_reasons_form" name="create_reasons_form" class="form-horizontal">
            {{ csrf_field() }}
