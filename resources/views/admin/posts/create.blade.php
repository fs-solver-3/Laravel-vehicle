...
<section class="section-1">
    <div class="section-content--main__wrap box-bg2 pb-0">
        <div class="section-content--main">
            ...
            <form method="POST" action="{{ route('admin.posts.store', app()->getLocale()) }}" accept-charset="UTF-8"
                id="create_posts_form" name="create_posts_form" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()">
                {{ csrf_field() }}
                <div class="section-top-side">
                    <div class="section-top-block--back">
                        <a href="{{ route('admin.posts.index', app()->getLocale()) }}" title="Show All Lessons">
                        ...
                        <div class="section-block--title">@lang('global.create_new') @lang('global.post.title')</div>
                    </div>
                </div>
