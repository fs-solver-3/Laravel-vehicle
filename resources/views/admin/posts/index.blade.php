...
@section('content')
        ...
        <div class="filter-main box-bg2">
            ...
            <div class="section-bottom-side filter-balance-bottom row m-0">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 section-input-wrap pl-0">
                    ...
                    <div class="section-select--input2 section-select--input__show" id="period"><span>@lang('global.not_set')</span>
            ...
            <div class="section-content--main">
                <div class="section-top-side">
                    <div class="section-block-title-question">
                        <div class="section-block--title">@lang('global.post.title')</div>
                    </div>
                        ...
                        <div class="section-block-added-csv">
                            ...
                            <div class="filter-side--right">
                                <a href="{{ route('admin.posts.create', ['locale' => app()->getLocale()]) }}" class="links" title="Create news">
                ...
                <div class="table-content">
                    @include('admin.posts.table_template')
                </div>
        ...
        <div class="section-content--main-mobile__wrap">
            <div class="section-content--main box-bg2 pb-20px">
                ...
                <div class="table-content-mobile">
                    @include('admin.posts.table_template_mobile')
                </div>
            </div>
        </div>
    </section>
 ...
 <script>    
        window.route_mass_crud_entries_destroy = '{{ route('admin.posts.mass_destroy', app()->getLocale()) }}';
</script>
        ...
        function filter_data() {
            ...
            if(from_date != "" && to_date != "" && from_date != to_date){
                $.ajax({
                    ...
                    , url: "{{ route('admin.posts.index', app()->getLocale()) }}"
                    , data: {
                        name: name
                        , from_date: from_date
                        , to_date: to_date
