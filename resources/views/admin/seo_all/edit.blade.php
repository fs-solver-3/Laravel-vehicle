    ...
    @section('content')
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading clearfix">
                ...
                <div class="pull-left">
                    <a href="{{ route('admin.seo_all.index', app()->getLocale()) }}" class="back_to_link" title="Show All Lessons">
                        <img src="{{asset('admin/left-arrow.svg')}}" class="left-arrow" alt="for you">
                    </a>
                    <span class="pull-left admin-form-title">
                        <h4 >{{ !empty($seoAll->name) ? $seoAll->name : 'Posts' }}</h4>
                    </span>
                </div>
                <div class="btn-group btn-group-sm pull-right" role="group">
                    <a href="{{ route('admin.seo_all.create', app()->getLocale()) }}" class="btn btn-add" title="Create New Posts">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="{{ route('admin.seo_all.update',['locale' => app()->getLocale(), 'id' => $seoAll->id]) }}" id="edit_posts_form" name="edit_posts_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
