...
<div class="section-bottom-side--mobile__list">
	...
	<div class="section-bottom-side--mobile__item--wrap section-data-container--item">
		<div class="section-bottom-side--mobile__item">
			<div class="section-bottom-side--mobile__item--name">{{ $color->color }}</div>
		...
		<ul class="section-bottom-side--mobile__item--content">
			...
			<li class="section-mobile-table--item">
				<div class="section-mobile-table--item__left">@lang('global.color.title'):</div>
				<div class="section-mobile-table--item__right">{{ $color->color }}</div>
			</li>
			<li class="section-mobile-table--item">
				<div class="section-mobile-table--item__left"></div>
				<div class="section-mobile-table--item__right"><div style="background: {{$color->color}}; width: 100px; height: 20px;"></div></div>
			</li>
		</ul>
	</div>
	@endforeach
