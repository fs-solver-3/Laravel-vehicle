...
<section>
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <a class="back_to_link" href="{{ route('admin.colors.index', app()->getLocale()) }}">
                <img src="{{asset('admin/left-arrow.svg')}}" class="left-arrow" alt="for you">
            </a>

            <span class="pull-left admin-form-title">
                <h4>@lang('global.create_new') @lang('global.color.title')</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.colors.store', app()->getLocale()) }}" accept-charset="UTF-8" id="create_colors_form" name="create_colors_form" class="form-horizontal">
            {{ csrf_field() }}
