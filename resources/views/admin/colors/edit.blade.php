...
<ul class="choise-lang--list">
    <li class="choise-lang--item"
        data-value='{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), ['locale' => 'ru', 'id' => $colors->id])}}'>
    ...
    <li class="choise-lang--item"
        data-value="{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), ['locale' => 'uz', 'id' => $colors->id])}}">
        <div class="choise-lang--item__img"
...
<section class="section-1">
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
              ...
              <div class="pull-left">
                  <a href="{{ route('admin.colors.index', app()->getLocale()) }}" class="back_to_link" title="Show All Colors">
                      <img src="{{asset('admin/left-arrow.svg')}}" class="left-arrow" alt="for you">
                  </a>
                  <span class="pull-left admin-form-title">
                      <h4 >{{ !empty($colors->name) ? $colors->name : 'Color' }}</h4>
                  </span>
              </div>
              <div class="btn-group btn-group-sm pull-right" role="group">

                  <a href="{{ route('admin.colors.create', app()->getLocale()) }}" class="btn btn-add" title="Create New Color">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.colors.update', ['locale' => app()->getLocale(), 'id' => $colors->id]) }}" id="edit_colors_form" name="edit_colors_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
