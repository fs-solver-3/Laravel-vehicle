    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left admin-form-title">
                <h4>@lang('global.fast_answers.title')</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.fast_answers.store', app()->getLocale()) }}" accept-charset="UTF-8" id="create_demand_complexity_form" name="create_demand_complexity_form" class="form-horizontal">
                {{ csrf_field() }}
