        ...
        <div class="section-content--main">
            <div class="section-top-side">
                <div class="section-block-title-question">
                    <div class="section-block--title">@lang('global.fast_answers.title')</div>
                </div>
                <div class="filter-side--right">
                    <a href="{{ route('admin.fast_answers.create', app()->getLocale()) }}" title="Create New Fast Answer">
            ...
            <div class="section-content--main table-content">
                @include('admin.fast_answers.table_template')
            </div>
        </div>
    </div>
</section>
    ...
    <div class="section-content--main-mobile__wrap">
        <div class="section-content--main box-bg2 pb-20px">
            ...
            <div class="table-content-mobile">
                @include('admin.fast_answers.table_template_mobile')
            </div>
        </div>
    </div>
</section>
...
<script>
    window.route_mass_crud_entries_destroy = '{{ route('admin.fast_answers.mass_destroy', app()->getLocale()) }}';
</script>
    ...
    $(document).ready(function() {
        ...
        function fetch_data() {
            $.ajax({
                ...
                url: "{{ route('admin.fast_answers.index', app()->getLocale()) }}", 
                data: {
                    id: id, 
                    name: title
                }, 
