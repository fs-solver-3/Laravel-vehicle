    ...
    <section class="section-1">
        <div class="panel panel-default">
            ...
            <div class="panel-heading clearfix">
                <div class="pull-left">
                    ...
                    <span class="pull-left admin-form-title">
                        <h4>{{ !empty($role->title) ? $role->title : 'Roles' }}</h4>
                    </span>
                </div>
            ...
            <div class="panel-body clearfix">
                ...
                <form method="POST" action="{{ route('admin.roles.update', ['locale' => app()->getLocale(), 'id' => $roles->id]) }}" id="edit_roles_form" name="edit_roles_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
