    ...
    <section class="section-1">
        <div class="panel panel-default">
            ...
            <div class="panel-heading clearfix">
                <div class="pull-left">
                    ...
                    <span class="pull-left admin-form-title">
                        <h4>{{ !empty($demandStatus->name) ? $demandStatus->name : 'demandCategory' }}</h4>
                    </span>
                </div>
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="{{ route('admin.demand_status.update', ['locale' => app()->getLocale(), 'id' => $demandStatus->id]) }}" id="edit_demand_status_form" name="edit_demand_status_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
