  ...
  <div class="filter-main box-bg2">
    ...
    <div class="section-bottom-side filter-balance-bottom row m-0">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 section-input-wrap pl-0">
        <label>Id:</label>
        <input class="input-main" type="text" placeholder="Id..." id="license_id">
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 section-input-wrap pr-0">
        <label>@lang('global.license.fields.user'):</label>
    ...
    <div class="section-content--main">
      <div class="section-top-side">
        <div class="section-block-title-question">
          <div class="section-block--title">@lang('global.license.title')</div>
        </div>
        <div class="filter-side--right">
      ...
      <div class="section-bottom-side--scroll table-content">
        @include('admin.driver__lisences.table_template')
      </div>
    ...
    <div class="section-content--main box-bg2 pb-20px">
      <div class="section-top-side box-bg-mobile2">
        ...
        <div class="filter-side--right">
          <div class="section-top-added gogocar-arrow-button">
            <svg class="icon icon-plus ">
              <use xlink:href="{{asset('static/img/svg/symbol/sprite_admin.svg#paper')}}static/img/svg/symbol/sprite_admin.svg#plus"></use>
            </svg>
          </div>
        </div>
      </div>
      <div class="section-bottom-side--mobile__list table-content-mobile">
        @include('admin.driver__lisences.table_template_mobile')
      </div>
...
<script>
  window.route_mass_crud_entries_destroy = '{{ route('admin.driver__lisence.mass_destroy', app()->getLocale()) }}';
</script>
...
<script>
  window._token = '{{ csrf_token() }}';
    ...
    function filter_trip(){
        if($('#license_id').parent().css('display') != 'none')
        {
        ...
        $.ajax({
            ...
            url: "{{ route('admin.driver__lisence.filter', app()->getLocale()) }}",
            data: {
