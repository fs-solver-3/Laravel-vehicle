        ...
        <div class="section-content--main">
            <div class="section-top-side">
                <div class="section-block-title-question">
                    <div class="section-block--title">@lang('global.demand_complexity.title')</div>
                </div>
                <div class="filter-side--right">
                    <a href="{{ route('admin.demand_complexity.create', app()->getLocale()) }}" title="Create New Demand Category">
            ...
            <div class="section-content--main table-content">
                @include('admin.demand_complexities.table_template')
            </div>
        </div>
    </div>
</section>
    ...
    <div class="section-content--main-mobile__wrap">
        <div class="section-content--main box-bg2 pb-20px">
            ...
            <div class="table-content-mobile">
                @include('admin.demand_complexities.table_template_mobile')
            </div>
...
<script>
    window.route_mass_crud_entries_destroy = '{{ route('admin.demand_complexity.mass_destroy', app()->getLocale()) }}';
</script>
    ...
    $(document).ready(function() {
        ...
        function fetch_data() {
            $.ajax({
                ...
                url: "{{ route('admin.demand_complexity.index', app()->getLocale()) }}", 
                data: {
                    id: id, 
                    name: title
                }, 
