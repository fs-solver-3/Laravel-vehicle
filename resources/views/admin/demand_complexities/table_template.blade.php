    ...
    <table class="section-table" data-module="sticky-table" id="tblMain">
        ...
        <tbody class="section-data-container">
            @foreach ($demandComplexities as $demandComplexity)
                <tr class="section-data-container--item" data-entry-id="{{ $demandComplexity->id }}">
                    <td>
                    ...
                    <td class="section-tbody--icon section-tbody--show__popup">
                        ...
                        <div class="section-tbody--modal--table">
                            <a href="{{ route('admin.demand_complexity.show', ['locale' => app()->getLocale(), 'id' => $demandComplexity->id]) }}"
                            ...
                            <a href="{{ route('admin.demand_complexity.edit', ['locale' => app()->getLocale(), 'id' => $demandComplexity->id]) }}"
                            ...
                            <form method="POST"
                                action="{!!  route('admin.demand_complexity.destroy', ['locale' => app()->getLocale(), 'id' => $demandComplexity->id]) !!}"
                    ...
                    <td>{{ $loop->index + 1 }}</td>
                    <td>{{ $demandComplexity->grade }}</td>
                    <td>{{ $demandComplexity->name }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
