    ...
    <section class="section-1">
        <div class="panel panel-default">
            ...
            <div class="panel-heading clearfix">
                <div class="pull-left">
                    ...
                    <span class="pull-left admin-form-title">
                        <h4>@lang('global.demand_criticality.title')</h4>
                    </span>
                </div>
                <div class="btn-group btn-group-sm pull-right" role="group">

                    <a href="{{ route('admin.demand_complexity.create', app()->getLocale()) }}" class="btn btn-add" title="Create New demandCategory">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="{{ route('admin.demand_complexity.update', ['locale' => app()->getLocale(), 'id' => $demandComplexity->id]) }}" id="edit_demand_status_form" name="edit_demand_status_form" accept-charset="UTF-8" class="form-horizontal">
                    {{ csrf_field() }}
                    <input name="_method" type="hidden" value="PUT">
                    @include ('admin.demand_complexities.form', [
                    'demand_complexity' => $demandComplexity,
                    ])
                    ...
                    <div class="section-footer-side">
                        <div class="section-buttons--wrap">
                            ...
                            <a href="{{ route('admin.demand_complexity.index', app()->getLocale()) }}">
