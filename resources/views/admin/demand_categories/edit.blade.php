...
<section class="section-1">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.demand_categories.update', ['locale' => app()->getLocale(), 'id' => $demandCategory->id] ) }}" id="edit_demand_category_form" name="edit_demand_category_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
