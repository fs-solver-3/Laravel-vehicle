    ...
    <table class="section-table" data-module="sticky-table" id="tblMain">
        <thead>
            <tr>
                ...
                <th>@lang('global.demand_categories.fields.grade')</th>
                <th>@lang('global.demand_categories.fields.title')</th>
        ...
        <tbody class="section-data-container">
            ...
            <tr class="section-data-container--item" data-entry-id="{{ $demandCategory->id }}">
                <td>
                ...
                <td class="section-tbody--icon section-tbody--show__popup">
                    ...
                    <div class="section-tbody--modal--table">
                        <a href="{{ route('admin.demand_categories.show', ['locale' => app()->getLocale(), 'id' => $demandCategory->id]) }}" class="links" title="Show event">
                ...
                <td>{{ $loop->index + 1 }}</td>
                <td>{{ $demandCategory->grade }}</td>
                <td>{{ $demandCategory->name }}</td>
                <td>
                    @if ($demandCategory->manager)
                    @foreach ($demandCategory->manager as $item)
