        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading clearfix">
                ...
                <span class="pull-left admin-form-title">
                    <h4>@lang('global.create_new') @lang('global.permissions.title')</h4>
                </span>
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="{{ route('admin.permissions.store', app()->getLocale()) }}" accept-charset="UTF-8" id="create_permissions_form" name="create_permissions_form" class="form-horizontal">
                {{ csrf_field() }}
