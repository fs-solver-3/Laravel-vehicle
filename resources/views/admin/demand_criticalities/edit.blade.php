...
<section class="section-1">
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            <div class="pull-left">
                ...
                <span class="pull-left admin-form-title">
                    <h4 >{{ !empty($demandCriticality->name) ? $demandCriticality->name : 'demandCategory' }}</h4>
                </span>
            </div>
            <div class="btn-group btn-group-sm pull-right" role="group">

                <a href="{{ route('admin.demand_criticality.create', app()->getLocale()) }}" class="btn btn-add" title="Create New demandCategory">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.demand_criticality.update', ['locale' => app()->getLocale(), 'id' => $demandCriticality->id]) }}" id="edit_demand_status_form" name="edit_demand_status_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
                <input name="_method" type="hidden" value="PUT">
                @include ('admin.demand_criticalities.form', [
                'demandCriticality' => $demandCriticality,
                ])
                ...
                <div class="section-footer-side">
                    <div class="section-buttons--wrap">
                        ...
                        <a href="{{ route('admin.demand_criticality.index', app()->getLocale()) }}">
