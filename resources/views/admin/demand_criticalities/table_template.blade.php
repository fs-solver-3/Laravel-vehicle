    ...
    <table class="section-table" data-module="sticky-table" id="tblMain">
        ...
        <tbody class="section-data-container">
            @foreach ($demandCriticalities as $demandCriticality)
                <tr class="section-data-container--item" data-entry-id="{{ $demandCriticality->id }}">
                    <td>
                    ...
                    <td class="section-tbody--icon section-tbody--show__popup">
                        ...
                        <div class="section-tbody--modal--table">
                            <a href="{{ route('admin.demand_criticality.show', ['locale' => app()->getLocale(), 'id' => $demandCriticality->id]) }}"
                            ...
                            <a href="{{ route('admin.demand_criticality.edit', ['locale' => app()->getLocale(), 'id' => $demandCriticality->id]) }}"
                            ...
                            <form method="POST"
                                action="{!!  route('admin.demand_criticality.destroy', ['locale' => app()->getLocale(), 'id' => $demandCriticality->id]) !!}"
                    ...
                    <td>{{ $loop->index + 1 }}</td>
                    <td>{{ $demandCriticality->grade }}</td>
                    <td>{{ $demandCriticality->name }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
