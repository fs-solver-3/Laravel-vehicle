            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 section-balance-filter--date p-0 section-input-wrap">
                ...
                <div class="section-balance-filter--date__wrap">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 pl-0 pr-0">
                        <div class="section-balance-filter-date__wrap">
                            <input class="input-main calendar-filter-transaction calendar-zone-height" id="to_date" type="text">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 section-input-wrap pr-0">
                        <div class="section-balance-filter-date__wrap">
                            <input class="input-main calendar-filter-transaction calendar-zone-height" id="from_date" type="text">
                            <div class="section-balance-date--icon">
                                <svg class="icon icon-calendar ">
                                    <use xlink:href="{{asset('static/img/svg/symbol/sprite.svg#calendar')}}"></use>
                                </svg>
...
<div id="withdraw_container">
    @include('admin.dashboard.withdraw_template')
</div>
...
<script>
    ...
    function filter_trip(){
        ...
        $.ajax({
            ...
            url: "{{ route('admin.dashboard.withdraw', app()->getLocale()) }}",
            data: {
                from_date: from_date,
                to_date: to_date
            },
            success: (data) => {
                $('#withdraw_container').html(data['template']);
