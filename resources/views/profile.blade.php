        ...
        <div class="container">
            <div class="personal-settings--wrap">
                ...
                <div class="col-xl-9 col-lg-9 personal-content tab-content clearfix">
                    <div id="personal_data" class="tab-pane @if($request->get('tab') == 'personal_data') active @endif">
                        @include('profile.personal-settings')
                    </div>
                    <div id="profile_photo" class="tab-pane @if($request->get('tab') == 'photo') active @endif">
                        @include('profile.personal-photo')
                    </div>
                    <div id="my_preferences" class="tab-pane @if($request->get('tab') == 'preference') active @endif">
                        @include('profile.personal-prefes')
                    </div>
                    <div id="my_passport" class="tab-pane @if($request->get('tab') == 'passport') active @endif">
                        @include('profile.personal-passport')
                    </div>
                    <div id="my_driver_lisence" class="tab-pane @if($request->get('tab') == 'my_driver_lisence') active @endif">
                        @include('profile.personal-driver-lisence')
                    </div>
                    <div id="user_realiability" class="tab-pane @if($request->get('tab') == 'user_realiability') active @endif">
                        @include('profile.personal-save')
                    </div>
                    <div id="my_car" class="tab-pane 
                    @if( $request->get('tab') == 'car' || $request->get('add_car') == 'truck' || $request->get('add_car') == 'bus'
                    || $request->get('add_car') == 'car' || Route::currentRouteName()=='profile.car.edit' || Route::currentRouteName()=='profile.truck.edit') active @endif"
                    >
                        @include('profile.personal-car')
                    </div>
                    <div id="mailing_address" class="tab-pane @if($request->get('tab') == 'mailing_address') active @endif">
                        @include('profile.personal-mail')
                    </div>
                    <div id="received_feedback" class="tab-pane @if($request->get('tab') == 'received_feedback') active @endif">
                        @include('profile.personal-receive-review')
                    </div>
                    <div id="left_feedback" class="tab-pane @if($request->get('tab') == 'left_feedback') active @endif">
                        @include('profile.personal-left-review')
                    </div>
                    <div id="payment" class="tab-pane @if($request->get('tab') == 'payment') active @endif">
                        @include('profile.personal-pay')
                    </div>
                    <div id="payment_method" class="tab-pane @if($request->get('tab') == 'payment_method') active @endif">
                        @include('profile.personal-payment-method')
                    </div>
                    <div id="alerts" class="tab-pane @if($request->get('tab') == 'alerts') active @endif">
                        @include('profile.personal-notific')
                    </div>
                    {{-- <div id="posts" class="tab-pane">
                        @include('profile.personal-photo')
                    </div> --}}
                    <div id="account" class="tab-pane @if($request->get('tab') == 'account') active @endif">
                        @include('profile.personal-count')
                    </div>
                    <div id="support" class="tab-pane @if($request->get('tab') == 'support' || $request->get('demand_id') != null) active @endif">
                        @include('profile.personal-support')
                    </div>
                    <div id="password" class="tab-pane @if($request->get('tab') == 'password') active @endif">
                        @include('profile.personal-password')
                    </div>
                    <div id="close_account" class="tab-pane @if($request->get('tab') == 'close_account') active @endif">
                        @include('profile.personal-delete')
                    </div>
                </div>
            </div>
        </div>
