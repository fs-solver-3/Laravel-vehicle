        ...
        <div class="container">
            <div class="trip-map--wrap">
                <div class="col-xl-5 col-lg-5 col-md-7 col-sm-12 trip-map--absolute gogocar-box">
                    ...
                    <div class="main-section--title text-center mb-4">@lang('front.trip_map_deploy.drop_off')<span>@lang('front.trip_map_deploy.passenger') ?</span></div>
                    <form method="GET" action="{{ route('stopsPassengerEdit', app()->getLocale()) }}" onsubmit="return validateNewStop()" id="new_stops">
                        <div class="col-xl-12 col-lg-12 suggest-late--inputs">
                            ...
                            <div class="trip-map--buttons mt-3">
                                ...
                                <a class="gogocar-gray-button" href="{{ route('trip.edit', [app()->getLocale(), 't_id'=>$hashids->encode($listing->id)]) }}">
                                    <div class="">@lang('front.trip_map_deploy.cancel')</div>
                                </a>
                            </div>
                        </div>
                    </form>
        ...
        <div class="trip-map--buttons__mobile">
            <div class="container">
                <div class="trip-map--buttons mt-3">
                    ...
                    <a class="gogocar-gray-button" href="{{ route('trip.edit', [app()->getLocale(), 't_id'=>$hashids->encode($listing->id)]) }}" class="gogocar-gray-button">
