<div class="col-xl-7 col-lg-9 col-md-12 col-sm-12 trips-category--buttons">
    <div class="gogocar-gray-button w-170" onclick="search_ride('all')">@lang('front.trip_template.all')</div>
    <div class="gogocar-gray-button w-170" onclick="search_ride('passenger')">@lang('front.trip_template.passenger')</div>
    <div class="gogocar-gray-button w-170" onclick="search_ride('bus')">@lang('front.trip_template.bus')</div>
</div>
@php
    use Hashids\Hashids;
    $hashids = new Hashids();
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 gogocar-trip--item gogocar-trip-pagination--item">
                    <div class="gogocar-trip--item__top">
                        <div class="gogocar-trip--item-town__route">
                            <div class="gogocar-trip--item__town">
                                <span>{{ $trip->sourcecity->city }}</span>
                                <div class="gogocar-trip--item__town--when">
                                    <svg class="icon icon-calendar3 ">
                                        <use xlink:href="{{ asset('static/img/svg/symbol/sprite.svg#calendar3') }}">
                                        </use>
                                    </svg>
                                    @php
                    ...
                    <div class="gogocar-trip--item__bottom">
                        <div class="gogocar-drivers--profile--wrap">
                            @if($trip->carowner != null && $trip->carowner->avatar!=null)
                            ...
                            <div class="gogocar-trips-category--name__rating">
                                <div class="gogocar-trips-category--name__rating--attr--wrap">
                                    <div class="gogocar-trips-category--name__rating--wrap">
                                        <span class="gogocar-trips-category--name">{{ $trip->carowner->name }}</span>
                                        <div class="gogocar-trips-category--rating green-rating">
                                            ...
                                            </svg><span>{{ $trip->carowner->marks() }}</span>
                                        </div>
                                    </div>
                                    <div class="gogocar-trips-category--name__attr--list">
                                        @if(isset($trip->user_preferences))
                                            @if($trip->user_preferences->music_allowed == 'allow')
                                            ...
                                            @endif
                                            @if($trip->user_preferences->pet_allowed == 'allow')
                                            ...
                                            @endif
                                            @if($trip->user_preferences->dialog_allowed == 'allow')
                                            <div class="gogocar-trips-category--name__attr--item gogocar-attr--green">
                                            ...
                                            @endif
                                            @if($trip->user_preferences->smoking_allowed == 'allow')
                                            <div class="gogocar-trips-category--name__attr--item gogocar-attr--green">
