  ...
  function () {
    ...
    _createClass(Datepicker, [{
      ...
      value: function createItem(data) {
        ...
        return "<".concat(itemTag, " class=\"gogocar-calendar-days ").concat(classes.join(' '), "\" data-view=\"").concat(item.view, "\">").concat(item.text, "</").concat(itemTag, ">");
      }
    }, {
      key: "getValue",
